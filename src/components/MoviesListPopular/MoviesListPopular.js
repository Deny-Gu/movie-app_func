...
function MovieListPopular(props) {
            ...
            <Pagination
              onChange={(e) =>
                props.handleChangePagination(
                  e,
                  props.setPaginationPopular,
                  props.getMoviesPopular,
                )
              }
              showSizeChanger={false}
              current={props.paginationPopular}
              pageSize={20}
              total={props.totalPopularMovies}
            />
          </Footer>
        </>
      )}
